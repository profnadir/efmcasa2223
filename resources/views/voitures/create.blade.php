                ...
                <div class="p-6 text-gray-900">
                    <form method="post" action="{{ route('voitures.store') }}" class="mt-6 space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="immatriculation" name="immatriculation" type="text" class="mt-1 block w-full" :value="old('immatriculation')" />
                            <x-input-error class="mt-2" :messages="$errors->get('immatriculation')" />
                        </div>

                        <div>
                            <x-input-label for="num_assurance" :value="__('Numéro Assurance')" />
                            <x-text-input id="num_assurance" name="num_assurance" type="text" class="mt-1 block w-full" :value="old('num_assurance')" />
                            <x-input-error class="mt-2" :messages="$errors->get('num_assurance')" />
                        </div>

                        <div>
                            <x-input-label for="kilometrage" :value="__('Kilometrage')" />
                            <x-text-input id="kilometrage" name="kilometrage" type="text" class="mt-1 block w-full" :value="old('kilometrage')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="date_debut_location" name="date_debut_location" type="date" class="mt-1 block w-full" :value="old('date_debut_location')" />
                        ...
                        <div>
                            ...
                            <x-text-input id="date_fin_location" name="date_fin_location" type="date" class="mt-1 block w-full" :value="old('date_fin_location')" />
                            <x-input-error class="mt-2" :messages="$errors->get('date_fin_location')" />
                        </div>

                        <div>
                            <x-input-label for="client_id" :value="__('Client ID')" />
                            <x-text-input id="client_id" name="client_id" type="text" class="mt-1 block w-full" :value="old('client_id')" />
